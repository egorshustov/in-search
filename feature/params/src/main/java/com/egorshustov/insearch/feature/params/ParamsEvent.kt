...
import com.egorshustov.insearch.core.model.data.Gender
import com.egorshustov.insearch.core.model.data.Relation
...
internal sealed interface ParamsEvent {
    ...
    data class OnMessageShown(val uiMessageId: Long) : ParamsEvent
}